module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, is_feedback=false, sanitize_text=true, attachment=nil, message_timestamp = Time.now)
        convo = Mailboxer::Conversation.new({:subject => subject, :is_feedback => is_feedback})
